...
<body>
  ...
  <form class="form" method="POST" action="<?php echo $_SERVER['PHP_SELF']; ?>">
    ...
    <input class="form__input" type="text" name="name" placeholder="First name"
      value="<?php echo (isset($valName) ? $valName : '') ?>">
    <input class="form__input" type="text" name="surname"
      placeholder="Last name"
      value="<?php echo (isset($valSurName) ? $valSurName : '') ?>">
    <input class="form__input" type="email" name="email" placeholder="Email"
      value="<?php echo (isset($valEmail) ? $valEmail : '') ?>">
    <input class="form__input" type="password" name="password"
      placeholder="Password"
      value="<?php echo (isset($valPassword) ? $valPassword : '') ?>">
    <input class="form__input" type="password" name="confirmPass"
